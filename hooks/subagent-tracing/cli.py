...
@claude.command("subagent-stop-hook", hidden=True)
def subagent_stop_hook() -> None:
    """Hook handler invoked when a Claude Code subagent finishes."""
    subagent_stop_hook_handler()
